//Gronflax, this is a game of Tic-Tac-Toe, my online course asked for it to be made, I was required to use functions, loops & vectors. All of which I have done. 
//The game is replayable without closing terminal, keeps track of the score and will reset in the event of a draw. 
